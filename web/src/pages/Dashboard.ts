...
const leaderboard: LeaderboardEntry[] = [
  ...
  },
  {
    ...
    winRate: "57%",
    streak: "+3",
    gradient: "from-fuchsia-300 to-rose-200",
  },
];
...
const activityFeed = [
  {
    icon: "🎯",
    textKey: "dashboard.activity.item1",
  },
  {
    icon: "🔥",
    textKey: "dashboard.activity.item2",
  },
  {
    icon: "⚡",
    textKey: "dashboard.activity.item3",
  },
  {
    icon: "🛡️",
    textKey: "dashboard.activity.item4",
  },
];
        ...
        <div class="max-w-6xl mx-auto space-y-8">
          <section class="glass-panel card-shadow p-5 sm:p-6 space-y-5">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              <a href="/profil" data-nav class="px-4 py-2 rounded-full border border-emerald-400/40 text-sm font-semibold text-emerald-200 hover:bg-emerald-400/10 transition-colors">
